#a third try at controlling the pulse generator to reach desired functions - 
...
'''
Helper function to obtain the wait cycles and delay of a certain pulse to be generated 
parameters:
...
#define and set the internal clock cycle of the pulse generator
t0 = 1e-4 #20e-3
